...
MPESA_CONSUMER_KEY = 'M83OGYXtuaXGMTAyKWSGDrRcUwanGVCNFwwyIPXbgH7nCaeG'
MPESA_CONSUMER_SECRET = 'x8zxZZSjsKDAVEUETcXF5uq8dhTFHqheZbNNbyQmOOYx9pnuYYVEJaXGqocVk1GW'
...
# settings.py
CELERY_BROKER_URL = 'django://'  # Use Django's database as the broker
CELERY_ACCEPT_CONTENT = ['json']  # Specify content types
